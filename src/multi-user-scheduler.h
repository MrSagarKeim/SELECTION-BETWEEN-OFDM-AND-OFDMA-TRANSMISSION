...
protected:
  ...
  Time m_availableTime2;                 //!< the time available for frame exchange for SU
  bool m_initialFrame;                   //!< true if a TXOP is being started
  bool m_initialFrame2; 
...
private:
  ...
  /**
   * Compute the SU information required to perform a DL SU transmission.
   *
   * \return the information required to perform  DL SU transmission
   */
